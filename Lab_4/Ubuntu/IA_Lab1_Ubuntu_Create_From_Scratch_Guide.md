# IA Lab 1 — Ubuntu NetLogo Guide (Create the Model From Scratch)

Important:
This version is for **Ubuntu** and assumes you do **not** already have `lab1.nlogo`.
You will create a new NetLogo model from scratch.

## PART 1 — INSTALL AND OPEN NETLOGO ON UBUNTU

1. Download NetLogo from the official website in your browser.
2. Open a terminal.
3. Extract it somewhere in your home folder.
